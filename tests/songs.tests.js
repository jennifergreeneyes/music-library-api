...
describe("/songs", () => {
  ...
  describe("POST /artists/:artistId/albums/:albumId/songs", () => {
    it("it creates a new song for the given artist and album",
      (done) => {
        request(app)
          ...
          .then((res) => {
            ...
            Song.findByPk(res.body.id, { raw: true })
              .then((song) => {
                expect(song.name).to.equal("Lucidity");
      ...
      it("returns a 404 and does not create song if artist does not exist", (done) => {
          request(app)
          ...
          .then((res) => {
              ...
              expect(res.body).to.equal("The artist could not be found.");
      ...
      it("returns a 404 and does not create song is album does not exist", (done) => {
          request(app)
...
describe("with songs in the database", () => {
    ...
    describe("GET /artists/:artistId/songs", () => {
        it("gets all songs for an artist by the artist id", (done) => {
            request(app)
    ...
    describe(" GET/albums/:albumId/songs", () => {
        it("gets all songs for an album by the album id", (done) => {
            request(app)
        ...
        it("reeturns a 404 if the album does not exist", () => {
            request(app)
    ...
    describe("DELETE /songs/:songId", () => {
        it("deletes a song by song id", (done)=> {
            const song = songs[0];
            request(app)
